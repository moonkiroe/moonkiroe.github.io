...
<div style="text-align: center;"><p style="text-align: center;" font size="2"> | <a href="supporttech.php3">Support</a> | <a href="faq.php3" >FAQ</a> | <a href="aide.php3">Aide</a> | </div></p><br>

<center><b>Support Technique</b></center><br><br>

Actuellement, le support technique est disponible pour tous.<br><br>

Par la suite, lorsque les abonnements seront opérationnels, le support il sera réservé en priorité aux Abonnés.<br><br>

<div id="sub_container3">Nous avons mis à votre disposition un formulaire pour reporter les bugs, problème de compte,  un abus dans le jeu (insulte, bot ou autre).<br><br>


<center> | <a HREF="support_form.php3" >Accès au formulaire</a> | </center><br><br>

En ce qui concerne les problèmes rencontrés dans le jeu, qui ne sont pas des bugs, comme les problèmes de configuration de téléchargement, d'installation, etc.. Nous vous conseillons de consulter la FAQ (foire aux questions).<br>
</div>
</font></p></div></div></div>
